      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading text-uppercase">Educational Details</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-4">
            <div class="team-member">
              <img class="mx-auto rounded-circle" src="../assets/img/ram.png"  />
          ...
          <div class="col-sm-4">
            <div class="team-member">
              <img class="mx-auto rounded-circle" src="../assets/img/texas.jpeg" />
          ...
          <div class="col-sm-4">
            <div class="team-member">
              <a href="https://www.youtube.com/watch?v=hjF2-74c7XI" target="_blank">
              <img class="mx-auto rounded-circle" src="../assets/img/techTalk.png" /></a>
              <h4>Public Talks :</h4>
              <p class="text-muted">“Application Security” Jeeny and Bractlet Speaker Series</p>
              <ul class="list-inline social-buttons">
                <li class="list-inline-item">
                  <a href="#">
                    <i class="fab fa-twitter"></i>
