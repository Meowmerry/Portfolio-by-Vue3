<template>
  <!-- WorkExperience -->
  <section class="page-section about" id="experience" data-aos="fade-up">
    <div class="container">
      <div class="row">
            ...
            <li>
              ...
              <div class="timeline-panel">
                <div class="timeline-heading">
                  ...
                  <h3 class="subheading">Gigamon</h3>
...
micro-actions across the app’s components for efficient debugging.</li>
            ...
            <li class="timeline-inverted">
              ...
              <div class="timeline-panel">
                <div class="timeline-heading">
                  <h4>2022</h4>
                  <h3 class="subheading">OPEN SOURCE | Sveltool Chrome DevTool</h3>
                  <h5>Software Engineer</h5>
                </div>
                <div class="timeline-body">
                  <ul class="b">
